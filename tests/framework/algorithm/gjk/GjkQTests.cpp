...
void GjkQTests::verify_chkIntersect_data()
{
    ...
    QTest::newRow("Test 1 - no intersect") << polygon1 << polygon2 << intersect_expect;
    ...
    QTest::newRow("Test 2 - no intersect") << polygon1 << polygon2 << intersect_expect;
    ...
    QTest::newRow("Test 3 - intersect") << polygon1 << polygon2 << intersect_expect;
    ...
    intersect_expect = true;
    QTest::newRow("Test 4 - intersect") << polygon1 << polygon2 << intersect_expect;
...
void GjkQTests::verify_chkIntersect()
{
    ...
    bool intersect = Gjk::chkIntersect(polygon1, polygon2);
